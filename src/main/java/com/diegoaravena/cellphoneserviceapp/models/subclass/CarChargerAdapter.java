...
@Entity
public class CarChargerAdapter extends Accessory {

    @Enumerated(EnumType.STRING)
    private ETypeChargingPin typeChargingPin;

    public CarChargerAdapter() {
    }

    public CarChargerAdapter(Brand brand, BrandAccessory brandAccessory, Double price, Integer stock,
